...
$help =
"Command line Sisconalep installer, creates config.php and initializes database.
...
--wwwroot=URL         Web address for the Sisconalep site,
                      required in non-interactive mode.
--dataroot=DIR        Location of the Sisconalep data folder,
                      must not be web accessible. Default is Sisconalepdata
                      in the parent directory.
--dbtype=TYPE         Database type. Default is mysqli
--dbhost=HOST         Database host. Default is localhost
--dbname=NAME         Database name. Default is Sisconalep
...
--adminuser=USERNAME  Username for the Sisconalep admin account. Default is admin
--adminpass=PASSWORD  Password for the Sisconalep admin account,
                      required in non-interactive mode.
--adminemail=STRING   Email address for the Sisconalep admin account.
...
if (version_compare(phpversion(), "5.6.5") < 0) {
    ...
    fwrite(STDERR, "Sisconalep 3.2 or later requires at least PHP 5.6.5 (currently using version $phpversion).\n");
    fwrite(STDERR, "Please upgrade your server software or install older Sisconalep version.\n");
    exit(1);
}
...
$CFG->docroot              = 'http://docs.Sisconalep.org';
...
if ($interactive) {
    if (!$options['agree-license']) {
        ...
        echo "Sisconalep  - Modular Object-Oriented Dynamic Learning Environment\n";
