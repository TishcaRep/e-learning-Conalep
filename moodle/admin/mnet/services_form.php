...
if (!defined('MOODLE_INTERNAL')) {
    die('Direct access to this script is forbidden.');    ///  It must be included from a Sisconalep page
}
    ...
    function definition() {
        ...
        foreach ($myservices as $name => $versions) {
            ...
            $langmodule =
                ...
                . $version['pluginname']; // TODO there should be a Sisconalep-wide way to do this
