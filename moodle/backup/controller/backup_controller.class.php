...
class backup_controller extends base_controller {
    ...
    protected $destination; // Destination chain object (fs_Sisconalep, fs_os, db, email...)
     ...
     * @param int $format The backup format to use; Most likely backup::FORMAT_Sisconalep
