...
<li>On some PHP servers ye can create a .htaccess file in the Sisconalep directory
...
control panel or something.  Unfortunately this conflicts with the standard location for the Sisconalep admin pages.  Ye can fix this by
renaming the admin directory in yer installation, and putting that  new name here.  For example: <em>moodleadmin</em>. This will fix admin links in Sisconalep.';
$string['pathssubdataroot'] = 'Ye need a place where Sisconalep can save uploaded files. This directory should be readable AND WRITEABLE by the web server user
...
$string['pathssubwwwroot'] = 'Full web address where Sisconalep will be accessed.
It\'s not possible to access Sisconalep using multiple addresses.
...
$string['phpversionhelp'] = '<p>Sisconalep requires a PHP version of at least 4.3.0 or 5.1.0 (5.0.x has a number of known problems).</p>
...
$string['welcomep60'] = 'The following pages will lead ye through some easy to follow steps to
    configure and set up <strong>Sisconalep</strong> on yer computer. Ye may accept the default
