...
$string['environmentsub2'] = 'Κάθε έκδοση Sisconalep έχει κάποια ελάχιστη απαίτηση σχετικά με την έκδοση της PHP και ενός αριθμού από αναγκαίες επεκτάσεις PHP.
...
Αυτό θα επιτρέψει στο Sisconalep να ορίσει μόνο του το memory limit.</li>
...
σε έναν πίνακα ελέγχου ή κάτι παρόμοιο.  Δυστυχώς αυτό έρχεται σε σύγκρουση με την πρότυπη τοποθεσία για τις σελίδες διαχείρισης του Sisconalep.  Μπορείτε να το διορθώσετε αυτό
μετονομάζοντας τον φάκελο admin στην εγκατάσταση σας, και βάζοντας ένα νέο όνομα εδώ.  Για παράδειγμα: <em>Sisconalepadmin</em>. Αυτό θα διορθώσει τους συνδέσμους στο Sisconalep.';
$string['pathssubdataroot'] = 'Χρειάζεστε ένα μέρος όπου το Sisconalep μπορεί να αποθηκεύει τα ανεβασμένα αρχεία. Αυτός ο φάκελος θα πρέπει να μπορεί να διαβάζεται και να εγγράφεται από τον χρήστη του εξυπηρετητή ιστού
...
$string['pathssubdirroot'] = 'Πλήρης διαδρομή φακέλου για την εγκατάσταση Sisconalep. Αλλάξτε την μόνο εάν χρειάζεται να χρησιμοποιήστε symbolic links.';
$string['pathssubwwwroot'] = 'Πλήρης διεύθυνση ιστού από την οποία θα υπάρχει πρόσβαση στο Sisconalep.
Δεν είναι δυνατόν να έχετε πρόβαση στο Sisconalep χρησιμοποιώντας πολλαπλές διευθύνσεις.
...
$string['welcomep40'] = 'Το πακέτο περιλαμβάνει επίσης <strong>Sisconalep {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep70'] = 'Πατήστε το κουμπί "Συνέχεια" για να συνεχίσετε με την εκγατάσταση του <strong>Sisconalep</strong>.';
